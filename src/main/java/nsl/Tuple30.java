...
public final class Tuple30 {
  private static final String FORMAT = "(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)";
  public class ImmutableTuple30<FIRST, SECOND, THIRD, FOURTH, FIFTH, SIXTH, SEVENTH, EIGHTH, NINTH, TENTH, ELEVENTH, TWELFTH, THIRTEENTH, FOURTEENTH, FIFTEENTH, SIXTEENTH, SEVENTEENTH, EIGHTEENTH, NINETEENTH, TWENTIETH, TWENTYFIRST, TWENTYSECOND, TWENTYTHIRD, TWENTYFOURTH, TWENTYFIFTH, TWENTYSIXTH, TWENTYSEVENTH, TWENTYEIGHTH, TWENTYNINTH, THIRTIETH> {
    ...
    private final TWENTYSEVENTH mTwentySeventh;
    private final TWENTYEIGHTH mTwentyEighth;
    private final TWENTYNINTH mTwentyNinth;
    private final THIRTIETH mThirtieth;
    protected ImmutableTuple30(
        final FIRST first,
        final SECOND second,
        final THIRD third,
        final FOURTH fourth,
        ...
        final TWENTYSEVENTH twentySeventh,
        final TWENTYEIGHTH twentyEighth,
        final TWENTYNINTH twentyNinth,
        final THIRTIETH thirtieth
    ) {
      mFirst = first;
      mSecond = second;
      mThird = third;
      ...
      mTwentySeventh = twentySeventh;
      mTwentyEighth = twentyEighth;
      mTwentyNinth = twentyNinth;
      mThirtieth = thirtieth;
      mToString = String.format(FORMAT, first, second, third, fourth, fifth, sixth, seventh, eighth, ninth, tenth, eleventh, twelfth, thirteenth, fourteenth, fifteenth, sixteenth, seventeenth, eighteenth, nineteenth, twentieth, twentyFirst, twentySecond, twentyThird, twentyFourth, twentyFifth, twentySixth, twentySeventh, twentyEighth, twentyNinth, thirtieth);
      mHashCode = Objects.hashCode(mFirst, mSecond, mThird, mFourth, mFifth, mSixth, mSeventh, mEighth, mNinth, mTenth, mEleventh, mTwelfth, mThirteenth, mFourteenth, mFifteenth, mSixteenth, mSeventeenth, mEighteenth, mNineteenth, mTwentieth, mTwentyFirst, mTwentySecond, mTwentyThird, mTwentyFourth, mTwentyFifth, mTwentySixth, mTwentySeventh, mTwentyEighth, mTwentyNinth, mThirtieth);
    }
    ...
    public TWENTYSEVENTH twentySeventh() { return mTwentySeventh; }
    public TWENTYEIGHTH twentyEighth() { return mTwentyEighth; }
    public TWENTYNINTH twentyNinth() { return mTwentyNinth; }
    public THIRTIETH thirtieth() { return mThirtieth; }
    ...
    public boolean equals(final Object obj) {
      if ((null == obj) || (getClass() != obj.getClass())) {
        ...
        final ImmutableTuple30 that = (ImmutableTuple30) obj;
        return Objects.equal(this.mFirst, that.mFirst)
            ...
            && Objects.equal(this.mTwentySeventh, that.mTwentySeventh)
            && Objects.equal(this.mTwentyEighth, that.mTwentyEighth)
            && Objects.equal(this.mTwentyNinth, that.mTwentyNinth)
            && Objects.equal(this.mThirtieth, that.mThirtieth);
      }
    }
  }
  public class MutableTuple30<FIRST, SECOND, THIRD, FOURTH, FIFTH, SIXTH, SEVENTH, EIGHTH, NINTH, TENTH, ELEVENTH, TWELFTH, THIRTEENTH, FOURTEENTH, FIFTEENTH, SIXTEENTH, SEVENTEENTH, EIGHTEENTH, NINETEENTH, TWENTIETH, TWENTYFIRST, TWENTYSECOND, TWENTYTHIRD, TWENTYFOURTH, TWENTYFIFTH, TWENTYSIXTH, TWENTYSEVENTH, TWENTYEIGHTH, TWENTYNINTH, THIRTIETH> {
    ...
    private TWENTYSEVENTH mTwentySeventh;
    private TWENTYEIGHTH mTwentyEighth;
    private TWENTYNINTH mTwentyNinth;
    private THIRTIETH mThirtieth;
    protected MutableTuple30() { }
    protected MutableTuple30(
      final FIRST first,
      final SECOND second,
      final THIRD third,
    ...
    public TWENTYSEVENTH setTwentySeventh(final TWENTYSEVENTH newTwentySeventh) { final TWENTYSEVENTH oldTwentySeventh = mTwentySeventh; mTwentySeventh = newTwentySeventh; return oldTwentySeventh; }
    public TWENTYEIGHTH setTwentyEighth(final TWENTYEIGHTH newTwentyEighth) { final TWENTYEIGHTH oldTwentyEighth = mTwentyEighth; mTwentyEighth = newTwentyEighth; return oldTwentyEighth; }
    public TWENTYNINTH setTwentyNinth(final TWENTYNINTH newTwentyNinth) { final TWENTYNINTH oldTwentyNinth = mTwentyNinth; mTwentyNinth = newTwentyNinth; return oldTwentyNinth; }
    public THIRTIETH setThirtieth(final THIRTIETH newThirtieth) { final THIRTIETH oldThirtieth = mThirtieth; mThirtieth = newThirtieth; return oldThirtieth; }
    public String toString() { return String.format(FORMAT, mFirst, mSecond, mThird, mFourth, mFifth, mSixth, mSeventh, mEighth, mNinth, mTenth, mEleventh, mTwelfth, mThirteenth, mFourteenth, mFifteenth, mSixteenth, mSeventeenth, mEighteenth, mNineteenth, mTwentieth, mTwentyFirst, mTwentySecond, mTwentyThird, mTwentyFourth, mTwentyFifth, mTwentySixth, mTwentySeventh, mTwentyEighth, mTwentyNinth, mThirtieth); }
    public int hashCode() { return Objects.hashCode(mFirst, mSecond, mThird, mFourth, mFifth, mSixth, mSeventh, mEighth, mNinth, mTenth, mEleventh, mTwelfth, mThirteenth, mFourteenth, mFifteenth, mSixteenth, mSeventeenth, mEighteenth, mNineteenth, mTwentieth, mTwentyFirst, mTwentySecond, mTwentyThird, mTwentyFourth, mTwentyFifth, mTwentySixth, mTwentySeventh, mTwentyEighth, mTwentyNinth, mThirtieth); }
    public boolean equals(final Object obj) {
      if (null == obj || getClass() != obj.getClass()) {
        return false;
      } else {
        final MutableTuple30 that = (MutableTuple30) obj;
        return Objects.equal(this.mFirst, that.mFirst)
            && Objects.equal(this.mSecond, that.mSecond)
            && Objects.equal(this.mThird, that.mThird)
            && Objects.equal(this.mFourth, that.mFourth)
